...
export default function AboutSection() {
  return (
    <section id="about" className="py-24 bg-[#F6E4CF] rounded-t-[25px] relative z-10 mt-[-25px]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="card-hover bg-[#FFF9F2] border border-[#D9C4AA] rounded-3xl overflow-hidden group">
            <div className="h-64 bg-cover bg-center" style={{ backgroundImage: "url('https://i.ibb.co/8nk0rjz1/20251006-065800.png')" }} />
            <div className="p-8">
          ...
          <div className="card-hover bg-[#FFF9F2] border border-[#D9C4AA] rounded-3xl overflow-hidden group">
            <div className="h-64 bg-cover bg-center" style={{ backgroundImage: "url('https://i.ibb.co/1tyF9xV6/20251006-065939.jpg')" }} />
            <div className="p-8">
          ...
          <div className="card-hover bg-[#FFF9F2] border border-[#D9C4AA] rounded-3xl overflow-hidden group">
            <div className="h-64 bg-cover bg-center" style={{ backgroundImage: "url('https://i.ibb.co/sJvHDNwM/IMG-20250918-111813.jpg')" }} />
            <div className="p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-[#FFF9F2] border border-[#D9C4AA] p-10 rounded-3xl">
